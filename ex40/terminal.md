[a@DESKTOP-AAAAAAA ex40]$ make clean all
rm -rf build src/lcthw/ex35.o src/lcthw/list.o src/lcthw/hashmap.o src/lcthw/hashmap_algos.o src/lcthw/ex36.o src/lcthw/darray.o src/lcthw/bstree.o src/lcthw/radixmap.o src/lcthw/list_algos.o src/lcthw/string_algos.o src/lcthw/bstrlib.o src/lcthw/darray_algos.o tests/list_tests tests/list_algos_tests tests/radixmap_tests tests/darray_algos_tests tests/string_algos_tests tests/hashmap_tests tests/darray_tests tests/bstree_tests tests/hashmap_algos_tests
...
Running unit tests:
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\bstree_tests.exe
ALL TESTS PASSED
Tests run: 6
tests/bstree_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\darray_algos_tests.exe
ALL TESTS PASSED
Tests run: 3
tests/darray_algos_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\darray_tests.exe
ALL TESTS PASSED
Tests run: 8
tests/darray_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\hashmap_algos_tests.exe
ALL TESTS PASSED
Tests run: 4
tests/hashmap_algos_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\hashmap_tests.exe
ALL TESTS PASSED
Tests run: 5
tests/hashmap_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\list_algos_tests.exe
ALL TESTS PASSED
Tests run: 2
tests/list_algos_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\list_tests.exe
ALL TESTS PASSED
Tests run: 6
tests/list_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\radixmap_tests.exe
ALL TESTS PASSED
Tests run: 1
tests/radixmap_tests.exe PASS
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\string_algos_tests.exe
ALL TESTS PASSED
Tests run: 1
tests/string_algos_tests.exe PASS

[a@DESKTOP-AAAAAAA ex40]$ tests/bstree_tests.exe
DEBUG tests/bstree_tests.c:176: ----- RUNNING: C:\a\learn-c-the-hard-way-
on-windows\ex40\tests\bstree_tests.exe
----
RUNNING: C:\a\learn-c-the-hard-way-on-windows\ex40\tests\bstree_tests.exe
...
----- test_fuzzing
DEBUG tests/bstree_tests.c:137: 8839
DEBUG tests/bstree_tests.c:137: 9928
DEBUG tests/bstree_tests.c:137: 9984
ALL TESTS PASSED
Tests run: 6